...
DROP TABLE IF EXISTS `extensions_theme`;

CREATE TABLE `extensions_theme` (
...
CREATE TABLE `panel_admins` (
  ...
  `theme` varchar(255) NOT NULL default 'EWC',
...
INSERT INTO `panel_settings` (`settinggroup`, `varname`, `value`) VALUES
	...
	('panel', 'default_theme', 'EWC'),

	('panel', 'password_min_length', '0'),

	('panel', 'adminmail_defname', 'EWC Administrator'),
