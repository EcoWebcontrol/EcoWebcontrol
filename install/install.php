...
if(file_exists('../lib/userdata.inc.php'))
{
	...
	if(isset($sql)
	   && is_array($sql)
		...
		$installed_hint = file_get_contents('../templates/EWC/misc/alreadyinstalledhint.tpl');
		die($installed_hint);
	}
}
...
<head>
	...
	<link rel="stylesheet" href="../templates/EWC/assets/css/main.css"  />
	<!--[if IE]><link rel="stylesheet" href="../templates/EWC/assets/css/main_ie.css"  /><![endif]-->
	<!--[if lt IE 9]><script src="http://html5shiv.googlecode.com/svn/trunk/html5.js"></script><![endif]-->
	<script type="text/javascript" src="../js/jquery.min.js"></script>
	<script type="text/javascript" src="../templates/EWC/assets/js/main.js"></script>
	<link href="../templates/EWC/assets/img/favicon.ico" rel="icon" type="image/x-icon" />
	<title>EWC Server Management Panel - Installation</title>
	<style>
	input {
		background: #dae7ee url('../templates/EWC/assets/img/icons/text_align_left.png') no-repeat 5px 4px;
	}
	input[type="password"] {
		background: #dae7ee url('../templates/EWC/assets/img/icons/password.png') no-repeat 4px 4px;
	}
	input[type="submit"] {
		background: #ccc url('../templates/EWC/assets/img/icons/button_ok.png') no-repeat 4px 8px;
	}
	</style>
</head>
<body>
...
?>
	<article class="install bradius">
		<header class="dark">
			<img src="../templates/EWC/assets/img/logo.png" alt="EWC Server Management Panel" />
		</header>
...
<?php
	...
	if($tables_exist)
	{
		$filename = "/tmp/ewc_backup_" . date('YmdHi') . ".sql";
	...
	$db->query("INSERT INTO `" . TABLE_PANEL_ADMINS . "` SET
		...
		`password` = '" . substr(sha1(md5($admin_pass1).$admin_pass1.sha1($admin_pass1)),-30,15) . "',
		`name` = 'Siteadmin',
	...
	$userdata = "<?php\n";
	$userdata.= "//automatically generated userdata.inc.php for EWC\n";
